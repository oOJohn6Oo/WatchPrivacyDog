...
public class TabLayout extends HorizontalScrollView {
  ...
  private final TimeInterpolator tabIndicatorTimeInterpolator = new FastOutSlowInInterpolator();
  ...
  public TabLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    setSelectedTabIndicatorColor(
        a.getColor(R.styleable.TabLayout_tabIndicatorColor, MaterialResourcesKt.getAttrColor(context, android.R.attr.colorAccent)));
    ...
    defaultTabTextAppearance = android.R.attr.textAppearanceButton;

    tabTextAppearance =
        a.getResourceId(R.styleable.TabLayout_tabTextAppearance, android.R.attr.textAppearanceButton);
    ...
    tabTextMultiLineSize = 12;
    scrollableTabMinWidth = (int) ViewUtils.dpToPx(context, 120);
  ...
  public final class TabView extends LinearLayout {
    ...
    int getContentWidth() {
      ...
      for (View view : new View[] {textView, iconView}) {
